#####################
### Gathers data on user charges in 1000 nok in home-based care
...
var_labels <- "User payments, home-based care, consolidated/konsern accounts"

### Varnames

var_names <- "user_payment_hbc"
...
write_csv(codebook, 
          path = paste(documentation.dir, 
                       "2_1_cb_user_payments_hbc_t05065.csv", sep = "/"))
...
write_csv(data, path = paste(datadir, "2_accounts", 
                             "2_1_user_payments_hbc_t05065.csv", sep = "/"))
